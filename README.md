...
get the app created:
    ...
    $ heroku apps:create shurly
    Creating shurly... done, stack is cedar
    http://shurly.herokuapp.com/ | git@heroku.com:shurly.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://shurly.herokuapp.com deployed to Heroku

    To git@heroku.com:shurly.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://shurly.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@shurly.herokuapp.com/repl
